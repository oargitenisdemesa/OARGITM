const translations = {
  es: {
    ...
    'calendar.kicker':'AGENDA','calendar.title':'Calendario','calendar.sub':'El calendario del club se publicará aquí mediante un documento PDF o Word.','calendar.docTitle':'Calendario de competición','calendar.placeholder':'Aqui se publica el documento que recoge el calendario en el toma parte el club.',
