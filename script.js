const translations = {
  es: {
    ...
    'news.kicker':'ACTUALIDAD','news.title':'Noticias','news.sub':'Federaciones y actualidad del tenis de mesa.','news.rfetm':'Real Federación Española de Tenis de Mesa','news.fvtm':'Federación Vasca de Tenis de Mesa','news.fgtm':'Federación Guipuzcoana de Tenis de Mesa',
    'calendar.kicker':'AGENDA','calendar.title':'Calendario','calendar.sub':'Calendario de competición del Open de Clubes CTD Sonia Etxazarreta.','calendar.docTitle':'Calendario temporada 26/27','calendar.placeholder':'Consulta el calendario completo en el documento oficial.','calendar.download':'Descargar PDF',
    ...
    'gallery.kicker':'OARGI','gallery.title':'Galería','gallery.speed':'Velocidad','gallery.competition':'Competición','gallery.training':'Entrenamiento','gallery.empty':'Próximamente incorporaremos más imágenes del club.',
  ...
  eu: {
    ...
    'news.kicker':'GAURKOTASUNA','news.title':'Albisteak','news.sub':'Mahai-teniseko federazioak eta gaurkotasuna.','news.rfetm':'Espainiako Mahai Teniseko Errege Federazioa','news.fvtm':'Euskal Mahai Tenis Federazioa','news.fgtm':'Gipuzkoako Mahai Tenis Federazioa',
    'calendar.kicker':'AGENDA','calendar.title':'Egutegia','calendar.sub':'CTD Sonia Etxazarreta Klubetako Openaren lehiaketa-egutegia.','calendar.docTitle':'2026/27 denboraldiko egutegia','calendar.placeholder':'Kontsultatu egutegi osoa dokumentu ofizialean.','calendar.download':'Deskargatu PDFa',
    ...
    'gallery.kicker':'OARGI','gallery.title':'Galeria','gallery.speed':'Abiadura','gallery.competition':'Lehiaketa','gallery.training':'Entrenamendua','gallery.empty':'Laster klubaren irudi gehiago gehituko ditugu.',
